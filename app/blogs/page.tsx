...
const Page = () => {
  return <main className="bg-[#07060f] relative text-white overflow-hidden">
    ...
    <Link href="https://medium.com/@0x5hmuel" target="_blank" referrerPolicy="no-referrer" className="flex items-center gap-x-1 text-white/80 absolute right-10 top-64 jost text-2xl<D-Space>leading-[130%] tracking-[-6%]">
      <MediumIcon />
...
function Grids() {
  ...
  return <div className="absolute inset-0 min-h-screen w-screen grid grid-cols-4">
  ...
  return <motion.a href="https://google.com" onClick={(e) => {
    ...
    <div className="flex-col justify-between flex gap-[1em] items-start h-full">
      ...
      <div className="items-end space-y-5">
        <p className="text-xl line-clamp-4 unbounded leading-[111%] tracking-[-6%]">{title}</p>
        <p className="text-white/40 line-clamp-3 satoshi">{description}</p>
        <div className="w-full flex items-center justify-between">
          <p className="jakarta text-[#CC9933]/70 text-xs font-semibold">Read More</p>
