    ...
    >
      <div className="absolute flex max-h-[60%] pt-2 left-0 w-full justify-center bottom-0">
        ...
        <div className="relative bottom-0">
          <Ellipse className=" w-[500px] md:w-screen" />
          <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 space-y-5">
            ...
            <p className="jost leading-[130%] tracking-[-0.02em] w-[304px] md:w-[577px] text-center text-[10px] lg:text-[25px] text-white/60 ">
            ...
            />
            <div className="relative bottom-[254px] md:left-[725px]">
