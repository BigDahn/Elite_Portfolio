...
const Page = () => {
  return (
    <div className="bg-black">
      ...
      <div className="bg-black -space-y-36 pb-24">
...
const ServiceCard = ({ label, description }: IServiceCard) => {
  ...
  return <div className="rounded-t-lg max-w-7xl mx-auto relative h-125">
    ...
    <div className="bg-[#0B0B0B] rounded-t-lg p-3 flex items-center z-30 relative justify-center flex-col">
      <h2 className="unbounded text-[50px] text-transparent leading-[93%] py-3 tracking-[-8%] bg-linear-to-b from-white to-blue-800 bg-clip-text">{label}</h2>
      <p className="jost leading-[120%] tracking-[-4%] text-2xl text-white/70">{description}</p>
    </div>
  </div>
